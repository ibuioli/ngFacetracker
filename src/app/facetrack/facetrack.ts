...
const deformer = require('./js/facedeformation.js');
const faceModel = require('./js/model_spca_20_svm.js');
...
export class FaceTracker {
  ...
  public clmInit() {
    ...
    this._defor.load(document.getElementById("image"), this._points, faceModel);//*/
  }
