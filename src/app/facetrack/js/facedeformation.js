...
module.exports  = {
  ...
  this.init = function(canvas) {
    ...
    gl = webgl_utils.getWebGLContext(canvas);
  ...
  this.load = function(element, points, pModel, vertices) {
    ...
    if (first) {
      ...
      var gridVertexShader = webgl_utils.loadShader(gl, gridVertexShaderProg, gl.VERTEX_SHADER);
      var gridFragmentShader = webgl_utils.loadShader(gl, gridFragmentShaderProg, gl.FRAGMENT_SHADER);
      try {
        gridProgram = webgl_utils.createProgram(gl, [gridVertexShader, gridFragmentShader]);
      } catch(err) {
      ...
      var vertexShader = webgl_utils.loadShader(gl, vertexShaderProg, gl.VERTEX_SHADER);
      var fragmentShader = webgl_utils.loadShader(gl, fragmentShaderProg, gl.FRAGMENT_SHADER);
      drawProgram = webgl_utils.createProgram(gl, [vertexShader, fragmentShader]);
